...
class EpicrisisPdfService {
  static Future<void> downloadEpicrisisPdf(Patient p) async {
    ...
    DateTime? birthDate = birthDateRaw is Timestamp
        ? birthDateRaw.toDate()
      ...
      pw.MultiPage(
        ...
        build: (pw.Context ctx) {
          return [
              ...
              children: [
                pw.TableRow(
                  ...
                  children: [
                    pw.Padding(
                      ...
                      child: pw.Text('Edad gestacional: $gestationalAge semanas', style: pw.TextStyle(fontSize: 10)),
                    ),
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(4),
                ...
                pw.TableRow(
                  children: [
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(4),
                      child: pw.Text('Peso: $birthWeight gramos', style: pw.TextStyle(fontSize: 10)),
                    ),
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(4),
                ...
                pw.TableRow(
                  ...
                  children: [
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(4),
                      child: pw.Text('Talla: $length cm', style: pw.TextStyle(fontSize: 10)),
                    ),
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(4),
                      child: pw.Text('PCD: Negativa', style: pw.TextStyle(fontSize: 10)),
                    ),
                  ],
                ),
                pw.TableRow(
                  children: [
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(4),
                      child: pw.Text('Perímetro cefálico: $headCircumference cm', style: pw.TextStyle(fontSize: 10)),
                    ),
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(4),
                ...
                pw.Expanded(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text('- Evaluación oftalmológica - Fondo de ojo: Pendiente - Evaluación al alta', style: pw.TextStyle(fontSize: 10)),
                      pw.Text('- Evaluación audiológica: Pendiente - Evaluación al alta', style: pw.TextStyle(fontSize: 10)),
                ...
                pw.Expanded(
                  ...
                  child: pw.Container(
                    ...
                    child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
                      ...
                      pw.SizedBox(height: 4),
                      pw.Row(children: [
                        pw.Expanded(flex: 3, child: pw.Text('Edad: $motherAge años', style: pw.TextStyle(fontSize: 10))),
            ...
            pw.SizedBox(height: 8),
            pw.Bullet(
              text: 'Lavate bien las manos con agua y jabón, y pasá suavemente por la zona una gasa con agua limpia. '
                    'Después tirala, no la dejes sobre el cordón. Tampoco tapes el cordón con el pañal, no uses "ombligueras", ni fajes al bebé.',
              style: pw.TextStyle(fontSize: 10),
            ),
            pw.Bullet(
              text: 'Antes de la caída del cordón umbilical te recomendamos no darle baños de inmersión, porque podría retrasar su secado y caída. '
