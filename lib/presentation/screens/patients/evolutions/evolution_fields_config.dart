...
const List<FieldConfig> neonatologyPage2 = [
  ...
  FieldConfig(key: 'feedingMlQuantity',      label: 'Cantidad de ML/3hs',           type: FieldType.number),

  FieldConfig(key: 'lf',                     label: 'LF',                           type: FieldType.checkbox),
  FieldConfig(key: 'lfMlQuantity',           label: 'Cantidad de ML/3hs',           type: FieldType.number),
