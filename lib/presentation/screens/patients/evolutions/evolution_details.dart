...
class EvolutionDetailsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EvolutionDetailsScreen> createState() =>
      _EvolutionDetailsScreenState();
}

class _EvolutionDetailsScreenState
    extends ConsumerState<EvolutionDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final evolutionAsync = ref.watch(
      evolutionDetailsProvider(widget.evolutionId),
    );
      ...
      body: patientAsync.when(
        ...
        data: (patient) {
          ...
          return evolutionAsync.when(
            ...
            error:
                (_, __) =>
                    const Center(child: Text('Error al cargar evolución')),
            data: (evolution) {
              if (evolution == null) {
  ...
  Widget _buildContent(
    ...
    final Map<String, dynamic> details =
        evolution['details'] as Map<String, dynamic>;
    ...
    //para el tiempo posible de edicion
                          ...
                          child:
                              isEditing && isNeonato
                                  ...
                                  : Column(
                                    ...
                                    children: [
                                      //Agrego campo braceletNumberOld para enf cambio pulsera
                                      if (specialty ==
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: Text(
                        isNeonato && _page == 1 ? 'Atrás' : 'Cancelar',
                      ),
                    ),
                  ),
  ...
  // Datos del profesional que evolucionó
  Widget _buildProfessionalInfo(
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(16),
      decoration: const BoxDecoration(
        border: Border(bottom: BorderSide(color: Color(0xFF4F959D), width: 1)),
      ),
                ...
                return Row(
                  ...
                  children: [
                    Radio<String>(
                      ...
                      onChanged:
                          (v) => setState(() => _formData['physicalExam'] = v),
                    ),
                    Text(opt),
                  ],
                );
    ...
    return Column(
      ...
      children: [
        ...
        CheckboxListTile(
          ...
          onChanged:
              (v) => setState(() => _formData['csvByShift'] = v ?? false),
        ),
        const SizedBox(height: 16),
        ...
        _buildEditableField(
          ...
          _formData['phototherapy'],
        ),
        const SizedBox(height: 16),
        _buildEditableField(
          neonatologyPage2.firstWhere((f) => f.key == 'medication'),
          _formData['medication'],
        ),
        const SizedBox(height: 16),
        _buildEditableField(
          neonatologyPage2.firstWhere((f) => f.key == 'observations'),
          _formData['observations'],
        ),
      ],
    );
  }

  // Decide si se hace _buildEditableField o _buildReadOnlyField
    ...
    switch (field.type) {
                  ...
                  if (parsed != null) {
                    ...
                    if ((field.min != null && parsed < field.min!) ||
                      ...
                      _validationErrors[field.key] =
                          'Debe estar entre ${field.min} y ${field.max}';
                    } else {
                      ...
                      return Row(
                        ...
                        children: [
                          Radio<String>(
                            value: option,
                            groupValue:
                                _formData[field.key] as String? ??
                                value?.toString(),
                            onChanged:
                                (v) => setState(() => _formData[field.key] = v),
                          ),
                          Text(option),
                        ],
                      );
      ...
      case FieldType.datetime:
        ...
        if (value != null) {
          ...
          //Descartamos la hora, quedamos solo con la fecha
  ...
  Future<void> _saveChanges() async {
    // Valida todos los campos obligatorios y rangos
    if (!_validateForm()) {
